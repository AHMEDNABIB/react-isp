			...
			<div className="hero ">
				<div className="hero-content text-center">
					<div className="max-w-md">
						<h1 className="text-3xl lg:text-5xl font-bold">Pay Through Bank</h1>
					</div>
				</div>
			</div>
			<div className="container">
				{/* <div className="flex flex-row flex-wrap justify-center  w-fit   ">
					<div className="items-center text-center mx-10  mt-[-3] ">
						<div className="card relative w-80 h-48 bg-base-100 shadow-xl mb-5 group hover:text-white hover:bg-[#5f66bf]  duration-1000 transform hover:scale-110 ">
							<figure className="mt-8">
								<TbWorldLatitude className="text-[#5f66bf] text-6xl group-hover:text-white duration-1000  " />
							</figure>
					...
					<div className="items-center  text-center mx-10    ">
						<div className="card relative items-center w-80 h-48 bg-[#F0F5F9] shadow-xl mb-5   ">
							<div className="flex  h-24 w-80 mx-5 items-center  bg-[#fff]">
								...
								<div>
									<h3>City Bank</h3>
									<p>Pay with your City Bank account</p>
								</div>
							</div>
							...
							<div className="col-span-1 bg-white border-2 border-slate-200 rounded-xl shadow-lg overflow-hidden text-anim2">
								<div className="p-5 flex items-center gap-4">
									...
									<div className="space-y-1">
										...
										<p className="text-base font-medium text-slate-700">
											Pay with your Dutch Bangla Bank
											account.
										</p>
									</div>
								</div>
